...
namespace HenryMod.Modules.CustomProjectiles
{
	...
	public class TimewinderProjectile : NetworkBehaviour, IProjectileImpactBehavior
	{
		private void Awake()
		{
				...
				switch (this.timewinderState)
				{
					case TimewinderProjectile.TimewinderState.FlyOut:
						if (NetworkServer.active)
						{
							...
							{
								this.stopwatch = 0f;
								this.NetworktimewinderState = TimewinderProjectile.TimewinderState.Transition;
								return;
							}
						}
						break;
