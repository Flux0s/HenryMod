...
namespace HenryMod.Modules.Survivors
{
    internal class Ekko : SurvivorBase
    {
        ...
        private static void CreateScepterSkills()
        {
            ...
            SkillDef bombSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_EKKO_BODY_SPECIAL_SCEPBOMB_NAME",
                skillNameToken = prefix + "_EKKO_BODY_SPECIAL_SCEPBOMB_NAME",
                skillDescriptionToken = prefix + "_EKKO_BODY_SPECIAL_SCEPBOMB_DESCRIPTION",
            ...
            SkillDef bazookaSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_EKKO_BODY_SPECIAL_SCEPBAZOOKA_NAME",
                skillNameToken = prefix + "_EKKO_BODY_SPECIAL_SCEPBAZOOKA_NAME",
                skillDescriptionToken = prefix + "_EKKO_BODY_SPECIAL_SCEPBAZOOKA_DESCRIPTION",
            ...
            {
                skillName = prefix + "_EKKO_BODY_PRIMARY_SCEPBAZOOKA_NAME",
                skillNameToken = prefix + "_EKKO_BODY_PRIMARY_SCEPBAZOOKA_NAME",
                skillDescriptionToken = prefix + "_EKKO_BODY_PRIMARY_SCEPBAZOOKA_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texBazookaFireIcon"),
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + "_EKKO_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + "_EKKO_BODY_MASTERY_SKIN_NAME",
            ...
            if (HenryPlugin.starstormInstalled)
            {
                ...
                SkinDef grandMasterySkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + "_EKKO_BODY_TYPHOON_SKIN_NAME",
            ...
            SkinDef vergilSkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + "_EKKO_BODY_VERGIL_SKIN_NAME",
            ...
            SkinDef danteSkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + "_EKKO_BODY_DANTE_SKIN_NAME",
